  ...
  try {
    ...
    if (response.statusCode == 200) {
      if (data['success']) {
        ...
        print('Login successful. Session state: $sessionState');
        return "Success";
      } else {
        // Handle unsuccessful login
        print('Login failed. Reason: ${data['reason']}');
      ...
      // Handle HTTP error
      print('HTTP error occurred. Status code: ${response.statusCode}');
      return "An error occurred. Please try again later.";
    }
  } catch (e) {
    // Handle exceptions
  ...
  try {
    ...
    if (response.statusCode == 200) {
      if (data['success']) {
        ...
        print('Logout failed. Reason: ${data['reason']}');
